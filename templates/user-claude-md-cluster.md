...
| `/audit-project` | Periodic project health check — cross-check docs, prune conventions, find drift |
| `/audit-skills` | Audit skills for bloat, trigger accuracy, structural quality, redundancy, and pruning |
